...
<head>
  ...
  <title>Alteração de Gerente</title>

  <!-- Icons -->
  <link rel="stylesheet" href="assets/fonts/style.css" />

  <!-- Styles -->
  <link rel="stylesheet" href="../style/stylecadgerent.css" />
    ...
    <form method="POST" action="../alterar/editar.php">
      <div>
        <div class="backtomenu">
          <a href="../listar/listar_gerentes.php">Voltar</a>
          <div class="space"></div>
        </div>
        ...
        <input class="button" type="submit" value="Editar" name="atualizar_gerente" />
      </div>
    </form>
  </main>
</body>
